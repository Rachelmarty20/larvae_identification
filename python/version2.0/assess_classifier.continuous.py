...
def main(test_photo, species, image_size, step, recombination):
    ...
    prediction_matrix = pickle.load(open("/cellar/users/ramarty/Data/ants/gold_standard/predictions/{0}/{1}.cont_{2}.{3}.{4}.p".format(species, test_photo, image_size, step, recombination), "rb"))
    ...
    with open("/cellar/users/ramarty/Data/ants/gold_standard/predictions/{0}/{1}.cont_{2}.{3}.{4}.txt".format(species, test_photo, image_size, step, recombination), 'w') as outfile:
    ...
    plt.savefig("/cellar/users/ramarty/Data/ants/gold_standard/predictions/{0}/{1}.cont_{2}.{3}.{4}.png".format(species, test_photo, image_size, step, recombination))
