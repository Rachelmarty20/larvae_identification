...
def main(test_photo, species, image_size, step, recombination):
    ...
    # Import classifier
    clf = joblib.load('/cellar/users/ramarty/Data/ants/gold_standard/classifiers/{0}/gradientboostingregressor.size_{1}.pkl'.format(species, image_size))
    ...
    pickle.dump(prediction_matrix_np, open("/cellar/users/ramarty/Data/ants/gold_standard/predictions/{0}/{1}.cont_{2}.{3}.{4}.p".format(species, test_photo, image_size, step, recombination), "wb"))
